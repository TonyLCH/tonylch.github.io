...
echo | wgcf register
wgcf generate
sed -i '/\:\:\/0/d' wgcf-profile.conf | sed -i 's/engage.cloudflareclient.com/[2606:4700:d0::a29f:c001]/g' wgcf-profile.conf | sudo sed -i 's/2606:4700:4700::1111,2606:4700:4700::1001,1.1.1.1,1.0.0.1/g' wgcf-profile.conf
